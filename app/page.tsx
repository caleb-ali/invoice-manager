...
export default function Home() {
  ...
  // Render a simple skeleton on the server to avoid any mismatch
  if (!mounted) {
    return (
              ...
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    ...
                    <dd className="text-lg font-semibold text-green-600">${stats.paid.toLocaleString()}</dd>
                  </dl>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    ...
                    <dd className="text-lg font-semibold text-yellow-600">${stats.pending.toLocaleString()}</dd>
                  </dl>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    ...
                    <dd className="text-lg font-semibold text-red-600">${stats.overdue.toLocaleString()}</dd>
                  </dl>
                </div>
              </div>
            </div>
